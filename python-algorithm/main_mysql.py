...
conn = MySQLdb.connect(host="127.0.0.1", user="root", passwd="", db="cuic", port = 3307)
cursor = conn.cursor()
...
wb_obj = openpyxl.load_workbook("C:/Users/Ramanan/Downloads/jan23-data.xlsx")
...
for row in sheet.iter_rows(values_only=True):
    ...
    try:
        ...
        # doc_id, text
            doc_data = [
                ["d1", convert_pdf_to_txt(f"D:/AU-CFR/python-backend/pubs/jan23-Ice/{app_gen_id}_1.pdf")],
                ["d2", convert_pdf_to_txt(f"D:/AU-CFR/python-backend/pubs/jan23-Ice/{app_gen_id}_2.pdf")],
                ["d3", convert_pdf_to_txt(f"D:/AU-CFR/python-backend/pubs/jan23-Ice/{app_gen_id}_3.pdf")],
                ["d4", convert_pdf_to_txt(f"D:/AU-CFR/python-backend/pubs/jan23-Ice/{app_gen_id}_4.pdf")],
                ["d5", convert_pdf_to_txt(f"D:/AU-CFR/python-backend/pubs/jan23-Ice/{app_gen_id}_5.pdf")],
                ["d6", convert_pdf_to_txt(f"D:/AU-CFR/python-backend/pubs/jan23-Ice/{app_gen_id}_6.pdf")],
            ]
            doc_df = pd.DataFrame(doc_data, columns=["doc_id", "text"])

        except Exception as e:
            print('Skipping', app_gen_id, '\n', e)
            continue
        ...
        dc_members.append({"name": str(dc1), "designation": str(dc1_designation), "department": str(dc1_dept), "college": str(dc1_college), "specialization": str(dc1_special), "score": dc1_score, "member_id": 1})
        dc_members.append({"name": str(dc2), "designation": str(dc2_designation), "department": str(dc2_dept), "college": str(dc2_college), "specialization": str(dc2_special), "score": dc2_score, "member_id": 2})
        dc_members.append({"name": str(dc3), "designation": str(dc3_designation), "department": str(dc3_dept), "college": str(dc3_college), "specialization": str(dc3_special), "score": dc3_score, "member_id": 3})
        dco_members.append({"name": str(dco1), "designation": str(dco1_designation), "department": str(dco1_dept), "college": str(dco1_college), "specialization": str(dco1_special), "score": dco1_score, "member_id": 4})
        dco_members.append({"name": str(dco2), "designation": str(dco2_designation), "department": str(dco2_dept), "college": str(dco2_college), "specialization": str(dco2_special), "score": dco2_score, "member_id": 5})
        dco_members.append({"name": str(dco3), "designation": str(dco3_designation), "department": str(dco3_dept), "college": str(dco3_college), "specialization": str(dco3_special), "score": dco3_score, "member_id": 6})
        ...
        cursor.execute(f"INSERT INTO membersdata (app_gen_id, name, title, dc_members, dco_members) \
